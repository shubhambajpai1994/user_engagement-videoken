...
def save_Assignment_data():
    ...
    for user in Assignment_clicks:
        ...
        #plt.show()
        plt.savefig("C:/Users/shubh/PycharmProjects/User_Engagement/Assignment_plot1/"+usr+".png")
        plt.clf()
    for user in Assignment_clicks:
        index = Assignment_clicks[user].keys()
        count = Assignment_clicks[user].values()
        plt.plot(index, count)
    plt.savefig("C:/Users/shubh/PycharmProjects/User_Engagement/source/Data_Extraction/assignment/Assignment_plot1.png");
    plt.show();
