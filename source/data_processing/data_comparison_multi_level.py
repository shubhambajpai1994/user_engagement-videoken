...
plt.title("Multi_level_video")
plt.savefig('/Users/shubham.bajpai/Documents/User_Engagement/source/data_processing/mean_multi_level_video.png')
...
for i in range(0,6):
    ...
    Y.append(26)
    plt.plot(Y,X, color = colors[i])
plt.title("Multi_level_non_video")
