...
plt.title("Hierarchial_with_constraint_video")
plt.savefig('/Users/shubham.bajpai/Documents/User_Engagement/source/data_processing/mean_hierarchial_with_constraint_video.png')
...
for i in range(0,6):
    ...
    Y.append(26)
    plt.plot(Y,X, color = colors[i])
plt.title("Hierarchial_with_constraint_non_video")
plt.savefig('/Users/shubham.bajpai/Documents/User_Engagement/source/data_processing/mean_hierarchial_with_constraint_non_video.png')
